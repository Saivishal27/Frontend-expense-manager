...
echo "<b>Expenses</b>";
echo "<br><br>";
echo "<b>Category</b>"."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"."<b>Price</b>";
$sum=0;
while($row = mysqli_fetch_array($result))
{
  echo "<br><br>".$row["Types"]."&nbsp&nbsp&nbsp&nbsp".$row["Price"];
  $sum+=$row["Price"];
}
echo "<br><br>";
...
echo "<br><br>";
        echo "<h2>Expenses Based on Category</h2>";
        echo "<form action='category2.php?m=$mon' method='post'>";
        echo "<fieldset>";
             echo "<label for='text'>Category</label>";
          echo "<input type='text' name='category' required>";
          echo "<button class='button button1'><em>Get Expenses</em></button>";
          echo "</fieldset>";
        echo "</form>";
        ?>
        <form action="main.php">
<button class='button button2'><em>Home</em></button>
</form>
</center>
</body>
</html>