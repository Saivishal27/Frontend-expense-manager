...
if(mysqli_query($conn,"SELECT * FROM category")){
echo "<b> All Expenses</b>";
echo "<br><br>";
echo "<b>Category</b>"."&nbsp&nbsp&nbsp&nbsp"."<b>Price</b>"."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"."<b>Date</b>";
while($row = mysqli_fetch_array($result))
{
  if($row["Price"]!=0){
  echo "<br><br>".$row["Types"]."&nbsp&nbsp&nbsp&nbsp".$row["Price"]."&nbsp&nbsp&nbsp&nbsp".$row["Date"];
}
