...
$cat=$_POST['category'];
$result=mysqli_query($conn,"SELECT * FROM category WHERE category.Types='$cat'") or die(mysqli_error());
if(mysqli_query($conn,"SELECT * FROM category WHERE category.Types='$cat'")){
echo "<b>Expenses</b>";
echo "<br><br>";
